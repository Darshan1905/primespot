...
<li class="menu-item"><a href="career">Career01</a></li>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="breadcrumbs">
                                    ...
                                    <div class="breadcrumb-trail link-style-2">
                                        <a class="home" href="/">Home</a><span>Career</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container career-con pt-5 pb-5 mt-5 mb-5">
                <div class="flat-trusted">
                    <div class="mark-page34 tf-mark "> <img src="assets/images/mark-page/dots.svg" alt="images"
                            style="width:70%"> </div>
                    <div class="mark-page35 tf-mark animate-up"> <img src="assets/images/mark-page/red-truck.svg"
                            alt="images" style="width:70%"> </div>
                    <div class="mark-page36 tf-mark "> <img src="assets/images/mark-page/hexagone.svg" alt="images"
                            style="width:70%"> </div>
                </div>
