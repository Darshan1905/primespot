...
<li class="menu-item"><a href="career">Career01</a></li>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="breadcrumbs">
                                    ...
                                    <div class="breadcrumb-trail link-style-2">
                                        <a class="home" href="/">Home</a><span>Clientele</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container  pb-5">
                ...
                <div class="row clientele-first-section pt-5 pb-5">
                    ...
                    <div class="col-lg-4 mt-5 pt-5"><img src="/assets/images/image-box/Client-101.png" width="100%"
                            alt="img" />
                        ...
                        <div class="home-slide-2 pt-5 pb-5">
                            ...
                            <div class="home-2 owl-carousel owl-theme">
                                ...
                                <div class="item" data-dot="<button>1</button>">
                                    <p><b>Get on Onboard:</b><br>Access our ecosystem of marketplace partners to list
                                        your products for a greateroutreach.</p>
                                </div>

                                <div class="item" data-dot="<button>2</button>">
                                    <p><b>Disseminate:</b><br>Utilize the intelligent inventory ERP software system to
                                        access pan-india fulfillment services with assured shipping and logistics.</p>
                                </div>

                                <div class="item" data-dot="<button>3</button>">
                                    <p><b>Organised Fulfillment:</b><br> Fulfill your consumer’s demands with our robust
                                        technology OF CRM, GOOGLE ADS, SOCIAL MEDIA STRATEGY, & fast and assured
                                        shipping, coherent packaging and efficient deliveries.</p>
                                </div>

                                <div class="item" data-dot="<button>4</button>">
                                    <p><b>Augment:</b><br>Draw from PrimeSpot’s full capabilities to hyperscale and
                                        hyper-personalise your business needs with real time insights and intelligent
                                        inventory for replenishments.</p>
                                </div>
            ...
            <section class="bg-clientele">
                <div class="container pt-3 text-center">
                    <h2 class="pt-5" style="color: #3262A1;">Our Partners</h2>
            ...
            <div class="container pt-5 pb-5">
                <div class="row pb-5">
                    <div class="col-lg-6 pt-5">
                        <h2 style="line-height: 1.2; text-align: justify;">Why partner with <span
                        ...
                        <p class="mt-4">PrimeSpot specializes in integrated e-commerce solutions for brands with special
                            ...
                            DKNY, CK and many more in the fragrance, beauty,
                            luggage & sunglass categories, PrimeSpot set out to service other organizations keeping in
                            mind the highest standards of efficiency and
                            networking to enable brands to tap into the booming business vertical of e-commerce.</p>
                    </div>
                    <div class="col-lg-6 cli-img text-center pt-5">
                        <div class="flat-trusted">
                            <div class="mark-page32 tf-mark "> <img src="assets/images/mark-page/dots.svg" alt="images"
                                    style="width:70%"> </div>
                            <div class="mark-page33 tf-mark "> <img src="assets/images/mark-page/hexagone.svg"
