...
<p style="text-align: justify;">PrimeSpot specializes in integrated e-commerce solutions for brands, with special expertise in premium and luxury brands.
 After tasting success with over 100+ brands like Bvlgari, Chopard, Hermes, Guess, DKNY, CK, Polaroid, and many more in the fragrance, beauty, 
luggage & sunglass categories; PrimeSpot set out to service other organizations keeping in mind the highest standards of efficiency and networking
...
<div class="pb-5">
  ...
  <input class="mt-2" type="email" required />
</div>
<div class="pb-5">
<label for=""><b> Mobile/Phone number</b></label>
<input class="mt-2" type="number" required />
</div>
<div class="pb-5">
...
<div class="form-half">
  <div class="pb-5 ">
    <label class="comp-lable" for=""
      ><b> Company name</b></label
    >
    <br />
    <input class="mt-2 contact-form-c-name " type="text" required />
  </div>
  <div class="pb-5">
    <label for=""><b> Profile link/ Document</b></label>
    <br />
    <input class="mt-2" type="file" required />
  </div>
</div>
<div class="pb-4">
  <label for=""><b> Message</b></label>
  <textarea class="mt-2" name="Message" id="" cols="30" rows="10">
  </textarea>
</div>
<button
  name="submit"
